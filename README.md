...
It is played asymmetricly between two players, meaning they each have different capabilities and roles within the game. One plays using Headphones and **Audio** Cues, while the other has a tablet and follows **Visual** cues:
...
As part of the Project it was evaluated with the target Audience, parents of young children which might play this game as a learning opportunity. Here are some of the main lessons we learned from these interviews:
